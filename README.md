...
This Windows app is built for writers and narrative designers to easily create, organize, and preview complex dialogue trees without coding. It connects seamlessly with the Unity Dialogue System, letting non-programmers define characters, emotions, and branching storylines with an intuitive interface. The app supports text styling (color, speed, size, bold, italic), animated effects (shake, wave, etc.), and action triggers that programmers can use in-game to start specific events — making collaboration between writers and developers fast, simple, and efficient.
...
This Windows application allows non-programmers — especially writers — to easily create, organize, and export dialogue data for Unity projects.

---

## 🧩 Overview

<img src="docs/pics/app.png" width="500" />
...
branch name automatically set in this order : branch**\*the number of line\*\*\***the number of brancher\*\*
